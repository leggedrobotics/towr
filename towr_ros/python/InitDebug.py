...
for i in range(10):
	Node_z_1.append(data_node[35+3*i])
	manual_Node_z_1.append(manual_data_node[35+3*i])
for i in range(8):
	Node_z_2.append(data_node[21*3+2+3*i])
	manual_Node_z_2.append(manual_data_node[21*3+2+3*i])
for i in range(8):
	Node_z_3.append(data_node[29*3+2+3*i])
	manual_Node_z_3.append(manual_data_node[29*3+2+3*i])
...
if (opt.ee=="LF"):
	...
	plt.plot(instance_axis, EE_d_0, label='EE_d_0')
	plt.plot(instance_axis, EE_c_0, label='EE_c_0')
	instance_axis_node = np.linspace(0,2.4,11)
...
if (opt.ee=="RF"):
	...
	plt.plot(instance_axis, EE_d_1, label='EE_d_1')
	plt.plot(instance_axis, EE_c_1, label='EE_c_1')
	instance_axis_node = np.linspace(0,2.4,10)
...
if (opt.ee=="LH"):
	...
	plt.plot(instance_axis, EE_d_2, label='EE_d_2')
	plt.plot(instance_axis, EE_c_2, label='EE_c_2')
	instance_axis_node = np.linspace(0,2.4,8)
